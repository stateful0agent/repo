## functions/
- `browser_use.py` — When to use: making a script that uses the browser

## scripts/
- `sync_secrets.py` — When to use: after modifying .env
...
- `get_programming_joke.py` — When to use: fetching a random programming joke
- `get_random_quote.py` — When to use: fetching a random quote
